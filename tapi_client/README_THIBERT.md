# tapi-client
A client library for accessing TAPI
...
```python
from tapi_client.models import MyDataModel
from tapi_client.api.my_tag import get_my_data_model
...
1. Any endpoint which did not have a tag will be in `tapi_client.api.default`
